...
struct AlertContext {
    //MARK: - Network Alerts
    static let invalidData          = AlertItem(title: Text("Server Error"), message: Text("The data received from the server was invalid. Pleaase contact support."), dismissButton: .default(Text("Ok")))
    ...
    static let userSaveSuccess     = AlertItem(title: Text("Profile Saved"), message: Text("Your profile information is saved successfully."), dismissButton: .default(Text("Ok")))
